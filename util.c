...
static void usage(int code) {
    fprintf(stderr,
            ...
            " -p PORT  listen on port (default is " Portdef "), can get from BEANSTALKD_PORT env var\n"
            ...
            " -P PWD   set password for the beanstalkd server (default is empty), can get from BEANSTALKD_PASSWORD env var\n"
