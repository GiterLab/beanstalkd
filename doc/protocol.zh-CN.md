...
### 验证指令说明（Authentication Commands）

#### `auth`

如果服务器开启了认证功能，客户端必须在连接时发送 `auth` 指令来认证身份。
...
Revised by tobyzxj: https://github.com/tobyzxj @ 2025-05-26
